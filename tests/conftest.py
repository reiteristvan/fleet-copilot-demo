...
The database fixtures live here because a second test module now needs them:
`tests/ingest/embedding/` exercises the embedding cache, which is in the same
migration chain as the fleet schema.
